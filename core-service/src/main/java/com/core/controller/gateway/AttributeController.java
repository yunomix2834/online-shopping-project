...
import com.core.dto.request.gateway.attribute.AssignAttributeRequestBody;
import com.core.dto.request.gateway.attribute.AttributeCreateRequestBody;
...
public class AttributeController {
  ...
  public Mono<ResponseEntity<Envelope<Void>>> create(
    ...
    return GrpcHelper.callGrpcVoid(channel,
        AttributeServiceGrpc::newBlockingStub,
  ...
  public Mono<ResponseEntity<Envelope<Envelope.Page<com.core.dto.response.gateway.attribute.AttributeView>>>> list(
    ...
    return GrpcHelper.callGrpc(channel,
        ...
        s -> s.list(AttributeListRequest.newBuilder()
            ...
            .setSize(size)
            .build()),
        p -> Envelope.Page.<com.core.dto.response.gateway.attribute.AttributeView>builder()
            .page(p.getPage())
            .size(p.getSize())
            .total(p.getTotal())
            .totalPages(p.getTotalPages())
            .docs(p.getDocsList().stream()
                .map(d -> new com.core.dto.response.gateway.attribute.AttributeView(
                    d.getId(),
                    d.getName(),
                    d.getValue()))
                .toList())
  ...
  public Mono<ResponseEntity<Envelope<Void>>> unassign(
      @RequestBody AssignAttributeRequestBody body) {
    return GrpcHelper.callGrpcVoid(channel,
        AttributeServiceGrpc::newBlockingStub,
  ...
  public Mono<ResponseEntity<Envelope<Envelope.Page<com.core.dto.response.gateway.attribute.AttributeView>>>> listByVariant(
