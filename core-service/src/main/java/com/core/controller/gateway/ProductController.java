...
import com.core.dto.request.gateway.product.AssignCategoryRequestBody;
import com.core.dto.request.gateway.product.ProductCreateRequestBody;
import com.core.dto.request.gateway.product.ProductUpdateRequestBody;
import com.core.dto.response.gateway.product.ProductView;
...
public class ProductController {
  ...
  public Mono<ResponseEntity<Envelope<Void>>> create(
    ...
    return GrpcHelper.callGrpcVoid(
        businessChannel,
        ProductServiceGrpc::newBlockingStub,
